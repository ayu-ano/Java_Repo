...
import java.util.*;
// parent class
abstract class Floyd_Warshall1{
    public int size;
    public Floyd_Warshall1(int size){
        this.size=size;
    }
...
class shortestPath1 extends Floyd_Warshall{
    public shortestPath1 (int K){
        super(K);
    }
...
public class Assignment5_Ayush_Kumar_683  {
    ...
    public static void main(String[] args) {
        ...
        int n = sc.nextInt();
        shortestPath1 fl=new shortestPath1(n);
